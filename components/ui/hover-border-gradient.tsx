...
export function HoverBorderGradient<T extends React.ElementType = "button">({
  ...
  return React.createElement(
    Tag,
    {
      ...
      className: cn(
        "relative flex rounded-full border content-center bg-black/20 hover:bg-black/10 transition duration-500 dark:bg-black items-center flex-col flex-nowrap gap-10 h-min justify-center overflow-visible p-px decoration-clone w-fit",
        containerClassName
      ),
      ...props,
    },
